...
export default function NewSalePage() {
  ...
  const cartProps = {
    ...
    onQuantity: updateQuantity, onRemove: removeFromCart,
    onPriceChange: updateItemPrice, onDiscountChange: updateDiscount,
    onDiscountTypeChange: setDiscountType, onGlobalDiscountChange: setGlobalDiscount,
    onSupplyQtyChange: updateSupplyQty, onSupplyRemove: removeSupply,
  };

  const optionsProps = {
    customers, accounts, hasSupplies, customerId,
    accountId, notes, grandTotal, shippingCost, isCreating,
    onCustomerChange: setCustomerId,
    onAccountChange:  handleAccountChange,   // ← deriva payment automáticamente
    ...
    <>
      ...
      <div className="lg:hidden fixed inset-0 top-16 flex flex-col bg-background">
        ...
        <div className="shrink-0 px-4 pt-3 pb-3 space-y-3 bg-background z-10 border-b">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" className="shrink-0" onClick={() => safeNavigate("/sales")}>
      ...
      <div className="hidden lg:flex flex-col h-[calc(100vh-4rem)] pb-4">
        ...
        <div className="shrink-0 flex items-center gap-3 py-3">
          <Button variant="ghost" size="icon" onClick={() => safeNavigate("/sales")}>
            <ArrowLeft className="h-4 w-4" />
          </Button>
